...
from fairseq.modules.rotary_multihead_attention import RotaryMultiheadAttention

class ESM2TransformerEncoderLayerBase(nn.Module):
    """Encoder layer block.
...
class ESM2TransformerEncoderLayer(ESM2TransformerEncoderLayerBase):
