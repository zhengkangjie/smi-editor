...
@register_model("levenshtein_transformer_smi")
class LevenshteinTransformerSMIModel(FairseqNATModel):
    @property
    ...
    def forward_decoder_model_dual_policy(
        self, src_tokens, encoder_out, src_lengths, prev_output_tokens, tgt_tokens, **kwargs
    ):
        ...
        with torch.no_grad():
            ...
            # print("word_predictions size:", word_predictions.size())
        ...
        word_del_out_2, _ = self.decoder.forward_word_del(
            normalize=False,
            prev_output_tokens=word_predictions,
            encoder_out=encoder_out,
        )
    ...
    def forward(
        ...
        ret_dual = self.forward_decoder_model_dual_policy(src_tokens, encoder_out, src_lengths, prev_output_tokens, tgt_tokens)
...
@register_model_architecture("levenshtein_transformer_smi", "levenshtein_transformer_smi")
...
@register_model_architecture(
    "levenshtein_transformer_smi", "levenshtein_transformer_smi_wmt_en_de"
)
...
@register_model_architecture(
    "levenshtein_transformer_smi", "levenshtein_transformer_smi_vaswani_wmt_en_de_big"
)
...
@register_model_architecture(
    "levenshtein_transformer_smi", "levenshtein_transformer_smi_wmt_en_de_big"
)
