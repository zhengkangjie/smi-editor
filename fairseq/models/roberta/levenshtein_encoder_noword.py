...
@register_model("levenshtein_encoder_noword")
class LevenshteinEncoderNoWordModel(FairseqEncoderModel):
    # @classmethod
    # def hub_models(cls):
    #     return {
...
@register_model_architecture("levenshtein_encoder_noword", "levenshtein_encoder_noword")
...
@register_model_architecture("levenshtein_encoder_noword", "levenshtein_encoder_noword_prenorm")
def levenshtein_encoder_noword_prenorm_architecture(args):
...
@register_model_architecture("levenshtein_encoder_noword", "levenshtein_encoder_noword_base")
def levenshtein_encoder_noword_base_architecture(args):
    p_base_architecture(args)


@register_model_architecture("levenshtein_encoder_noword", "levenshtein_encoder_noword_large")
def levenshtein_encoder_noword_large_architecture(args):
...
@register_model_architecture("levenshtein_encoder_noword", "levenshtein_encoder_noword_xlm")
