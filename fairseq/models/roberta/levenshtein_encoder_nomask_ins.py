...
@register_model("levenshtein_encoder_nomask_ins")
class LevenshteinEncoderNoMaskInsModel(FairseqEncoderModel):
    # @classmethod
    # def hub_models(cls):
    #     return {
...
@register_model_architecture("levenshtein_encoder_nomask_ins", "levenshtein_encoder_nomask_ins")
...
@register_model_architecture("levenshtein_encoder_nomask_ins", "levenshtein_encoder_nomask_ins_prenorm")
def levenshtein_encoder_nomask_ins_prenorm_architecture(args):
...
@register_model_architecture("levenshtein_encoder_nomask_ins", "levenshtein_encoder_nomask_ins_base")
def levenshtein_encoder_nomask_ins_base_architecture(args):
    p_base_architecture(args)


@register_model_architecture("levenshtein_encoder_nomask_ins", "levenshtein_encoder_nomask_ins_large")
def levenshtein_encoder_nomask_ins_large_architecture(args):
...
@register_model_architecture("levenshtein_encoder_nomask_ins", "levenshtein_encoder_nomask_ins_xlm")
