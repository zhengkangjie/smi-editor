...
class ESM2RobertaModel(FairseqEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
...
@register_model_architecture("p_roberta", "p_roberta_prenorm")
...
@register_model_architecture("p_roberta", "p_roberta_base")
def p_roberta_base_architecture(args):
    p_base_architecture(args)


@register_model_architecture("p_roberta", "p_roberta_large")
...
@register_model_architecture("p_roberta", "p_xlm")
