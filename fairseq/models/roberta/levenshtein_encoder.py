...
@register_model("levenshtein_encoder")
class LevenshteinEncoderModel(FairseqEncoderModel):
    # @classmethod
    # def hub_models(cls):
    #     return {
...
@register_model_architecture("levenshtein_encoder", "levenshtein_encoder")
...
@register_model_architecture("levenshtein_encoder", "levenshtein_encoder_prenorm")
def levenshtein_encoder_prenorm_architecture(args):
...
@register_model_architecture("levenshtein_encoder", "levenshtein_encoder_base")
def levenshtein_encoder_base_architecture(args):
    p_base_architecture(args)


@register_model_architecture("levenshtein_encoder", "levenshtein_encoder_large")
def levenshtein_encoder_large_architecture(args):
...
@register_model_architecture("levenshtein_encoder", "levenshtein_encoder_xlm")
